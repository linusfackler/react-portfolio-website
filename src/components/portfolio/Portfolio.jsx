...
const data = [
  {
    ...
    description: '• Developed a full-stack iOS app that allows users to self-diagnose for COVID-19 using AI/ML',
  ...
  },
  {
    ...
    description2: '• Integrated a machine-learning-based search algorithm using BERT to find text relations',
